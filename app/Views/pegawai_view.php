...
<body>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputno_hp">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                            ...
                            <div class="mb-7 row">
                                ...
                                <div class="col-sm-8">
                                    <select id="inputjenis_kelamin" class="form-select">
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(hasil) {
                    ...
                    if ($obj.id != '') {
                        ...
                        $('#inputno_hp').val($obj.no_hp);
                        $('#inputBidang').val($obj.bidang);
                        $('#inputAlamat').val($obj.alamat);
                        $('#inputjenis_kelamin').val($obj.jenis_kelamin);
                    }
                }
        ...
        $('#tombolSimpan').on('click', function() {
            ...
            var $jenis_kelamin = $('#inputjenis_kelamin').val();
